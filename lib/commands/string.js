...
exports.strlen = exports.setrange = exports.setnx = exports.setex = exports.setbit = exports.psetex = exports.msetnx = exports.mset = exports.mget = exports.incrbyfloat = exports.incrby = exports.incr = exports.getset = exports.getrange = exports.getbit = exports.decrby = exports.decr = exports.bitpos = exports.bitop = exports.bitfield = exports.bitcount = exports.append = exports.set = exports.get = void 0;
var __1 = require("../");
...
function get(key, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("get", callback, key);
    }
    else {
...
function set(key, value, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("set", callback, key, value);
    }
    else {
        __1.store[key] = value;
        return "OK";
...
function decr(key, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("decr", callback, key);
    }
    else {
        if (!__1.store[key]) {
            __1.store[key] = 0;
...
function decrby(key, value, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("decrby", callback, key, value);
    }
    else {
        if (!__1.store[key]) {
            __1.store[key] = 0;
...
function incr(key, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("incr", callback, key);
    }
    else {
        if (!__1.store[key]) {
            __1.store[key] = 0;
...
function incrby(key, value, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("incrby", callback, key, value);
    }
    else {
        if (!__1.store[key]) {
            __1.store[key] = 0;
...
function mget(keys, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("mget", callback, keys);
    }
    else {
...
function setex(key, seconds, value, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("setex", callback, key, seconds, value);
    }
    else {
...
function strlen(key, callback) {
    if (!(0, __1.isMasterNode)()) {
        __1.store.dispatch("strlen", callback, key);
    }
    else {
